...
// Configuration de base - utilise les routes admin
...
echo "\nPour tester l'upload d'images, utilisez:\n";
echo "- Le formulaire HTML: http://127.0.0.1:8000/test-image-upload.html\n";
echo "- Ou un client comme Postman avec l'URL: {$baseUrl}/questions\n";
?>
