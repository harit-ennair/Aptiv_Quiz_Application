...
<div class="space-y-6">
    ...
    <div id="formateurs-table" class="desktop-table bg-white rounded-xl shadow-sm border border-gray-200 hidden">
    ...
    <!-- Mobile Cards View -->
    <div id="formateurs-mobile" class="mobile-view space-y-4 hidden">
