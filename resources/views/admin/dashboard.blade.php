...
@section('title', 'Tableau de Bord - Admin Aptiv')
            ...
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Bienvenue, {{ $user->name }} {{ $user->last_name }}</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <span class="px-3 py-1 text-xs font-medium bg-aptiv-orange-100 text-aptiv-orange-800 rounded-full">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ App\Models\process::count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ App\Models\categories::count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ App\Models\test::count() }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <div>
                            <p class="font-medium text-gray-900">Ajouter un utilisateur</p>
                    ...
                    <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <div>
                            <p class="font-medium text-gray-900">Gérer les processus</p>
                            <p class="text-sm text-gray-600">Ajouter/Modifier les processus</p>
                        </div>
                    </a>
                    ...
                    <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <div>
                            <p class="font-medium text-gray-900">Paramètres système</p>
        ...
        <div class="bg-white rounded-lg shadow">
            ...
            <div class="p-6">
                <div class="text-center py-8 text-gray-500">
                    ...
                    <p class="text-sm">Aucune activité récente à afficher</p>
                </div>
            </div>
        </div>
    </div>
