            ...
            tbody.innerHTML = processes.map(process => `
                <tr>
                    ...
                    <button onclick="adminDashboard.editProcess(${process.id})" class="text-green-600 hover:text-green-900 mr-3" title="Modifier">
                        ...
                        <button onclick="adminDashboard.deleteProcess(${process.id})" class="text-red-600 hover:text-red-900" title="Supprimer">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow duration-200 card-hover">
                    ...
                    <div class="flex justify-between items-center pt-2 border-t border-gray-100">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <button onclick="adminDashboard.deleteProcess(${process.id})" class="text-red-600 hover:text-red-700 text-sm font-medium transition-colors btn-touch" title="Supprimer">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                </svg>
                            </button>
                                ...
                                <div class="category-card bg-white border border-gray-200 rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow duration-200" data-category-id="${category.id}">
                                    ...
                                    <div class="flex justify-between items-center pt-2 border-t border-gray-100">
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <button onclick="adminDashboard.deleteCategory(${category.id})" 
                                                    class="text-red-600 hover:text-red-700 text-xs font-medium transition-colors btn-touch" title="Supprimer">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                                </svg>
                                            </button>
